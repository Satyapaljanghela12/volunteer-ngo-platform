...
function AuthProvider({ children }) {
    ...
    const signup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[signup]": async (email, password, name, role)=>{
            setLoading(true);
            try {
                // Mock signup - replace with real API call
                await new Promise({
                    "AuthProvider.useCallback[signup]": (resolve)=>setTimeout(resolve, 500)
...
_s(AuthProvider, "GZNpoW7Q3aCkPQ1T8Q8TXBybUJ4=");
_c = AuthProvider;
function useAuth() {
    _s1();
