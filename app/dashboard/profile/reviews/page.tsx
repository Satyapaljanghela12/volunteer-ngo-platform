...
export default function ReviewsPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      <Link href="/dashboard/profile" className="text-primary hover:underline text-sm">
        ← Back to Profile
      </Link>

      <div>
        <h1 className="text-3xl font-bold text-foreground">Your Reviews</h1>
        <p className="mt-2 text-muted-foreground">See what others are saying about your volunteering</p>
      </div>
        ...
        {reviews.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground">
              No reviews yet. Complete some volunteering opportunities to get reviews!
            </p>
          </div>
        )}
      </div>
